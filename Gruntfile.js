// Generated on 2013-12-18 using generator-webapp 0.4.3
'use strict';
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        assemble: {
            ...
            i18nFR: {
                files: {
                    '.tmp/fr/': ['<%= yeoman.app %>/templates/pages/fr/*.hbs']
                }
            },
            i18nEN: {
                files: {
                    '.tmp/en/': ['<%= yeoman.app %>/templates/pages/en/*.hbs']
                }
            },
            server: {
                files: {
